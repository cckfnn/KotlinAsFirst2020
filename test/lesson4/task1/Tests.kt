...
class Tests {
    ...
    @Tag("7")
    fun russian() {
        assertEquals("восемьсот тридцать тысяч двести восемьдесят девять", russian(830289))
        assertEquals("восемьсот восемнадцать тысяч восемьсот тридцать два", russian(818832))
